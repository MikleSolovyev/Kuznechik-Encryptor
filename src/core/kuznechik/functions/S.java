...
public class S {
    ...
    private static final byte[] PiReverse = {
    ...
    public static byte[] direct(byte[] blockIn) {
        ...
        for (int i = 0; i < blockOut.length; i++) {
            blockOut[i] = Pi[(blockIn[i] + 256) % 256];
        }
    ...
    public static byte[] reverse(byte[] blockIn) {
        ...
        for (int i = 0; i < blockOut.length; i++) {
            blockOut[i] = PiReverse[(blockIn[i] + 256) % 256];
        }
    ...
    public static void testSelf() {
        ...
        byte[] b = S.direct(S.direct(S.direct(S.direct(a))));
        System.out.println("\tEncrypted: " + Arrays.toString(b));

        b = S.reverse(S.reverse(S.reverse(S.reverse(b))));
